...
python3 network_video_recorder/network_video_recorder.py -d CPU -m ./resources/models/intel/person-detection-retail-0013/FP32/person-detection-retail-0013.xml $args
